...
'''
    ...
    for func_arg_index, func_arg in enumerate(func_sig.parameters.values()):
        ...
        if  (func_arg.annotation is not inspect.Parameter.empty and
            ...
            if func_arg.kind is inspect.Parameter.KEYWORD_ONLY:
                func_body += '''
...
'''
    ...
    local_attrs = {'__beartype_func': func, 'wraps': wraps}
...
_RETURN_ANNOTATION_IGNORED = {inspect.Signature.empty, None}
'''
